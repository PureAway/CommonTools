...
public class PropertyQuery {
    ...
    /**
     * For string properties you can specify {@link QueryBuilder.StringOrder#CASE_SENSITIVE} if you
     ...
     * @throws NumericOverflowException if the sum exceeds the numbers {@link Long} can
     * represent.
