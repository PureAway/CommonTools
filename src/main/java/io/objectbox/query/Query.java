...
public class Query<T> implements Closeable {
     ...
     *
     * @throws NonUniqueResultException if result was not unique
     */
    @Nullable
    public T findUnique() {
     ...
     * the future.
     * <p>
     * Stale observers: you must hold on to the Query or {@link DataSubscription} objects to keep
     * your {@link DataObserver}s active. If this Query is not referenced anymore
     * (along with its {@link DataSubscription}s, which hold a reference to the Query internally),
     ...
     *
     * @param dataSubscriptionList the resulting {@link DataSubscription} will be added to it
     */
