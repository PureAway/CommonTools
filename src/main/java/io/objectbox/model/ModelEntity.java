...
public final class ModelEntity extends Table {
  ...
  public ModelProperty.Vector propertiesVector() { return propertiesVector(new ModelProperty.Vector()); }
  public ModelProperty.Vector propertiesVector(ModelProperty.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public ModelRelation.Vector relationsVector() { return relationsVector(new ModelRelation.Vector()); }
  public ModelRelation.Vector relationsVector(ModelRelation.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
