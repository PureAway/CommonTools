...
public final class RequestHistoryCursor extends Cursor<RequestHistory> {
    ...
    static final class Factory implements CursorFactory<RequestHistory> {
        @Override
        public Cursor<RequestHistory> createCursor(io.objectbox.Transaction tx, long cursorHandle, BoxStore boxStoreForEntities) {
    ...
    private final MapConverter headersConverter = new MapConverter();
    private final MapConverter queryMapsConverter = new MapConverter();
    ...
    public RequestHistoryCursor(io.objectbox.Transaction tx, long cursor, BoxStore boxStore) {
